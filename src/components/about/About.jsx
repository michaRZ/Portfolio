        ...
        <div className="about" id="about">
            ...
            <div className="right">
                <div className="wrapper">
                    <h2>About Me</h2>
                    <p>Having tried my hand at marketing, events, and even acting, I finally found an industry that spoke to my love of continuous learning when I landed a position in tech sales. I quickly found myself poking around the developers' space, and curiosity got the best of me when I dove into programming head-first.</p>
